...
def plot_faces(faces, num_faces, image_shape=(19, 19)):
    """
    Plots a selection of faces as images in a grid.
    
    Parameters:
    faces (numpy.ndarray): The matrix of faces with each column as a flattened face image.
    num_faces (int): Number of faces to select and plot.
    image_shape (tuple): The expected dimensions of the face images.
    """
